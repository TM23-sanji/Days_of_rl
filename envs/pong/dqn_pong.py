...
if __name__ == "__main__":
    ...
    parser.add_argument('--env', default=DEFAULT_ENV_NAME, help='Name of the env, default=' + DEFAULT_ENV_NAME)
    ...
    while True:
        ...
        if reward is not None:
            ...
            wandb.log({"epsilon": epsilon, "frame_idx": frame_idx})
            wandb.log({"speed": speed, "frame_idx": frame_idx})
            wandb.log({"reward_100": m_reward, "frame_idx": frame_idx})
            wandb.log({"reward": reward, "frame_idx": frame_idx})

            if best_m_reward is None or best_m_reward < m_reward:
                torch.save(net.state_dict(), args.env + '-best%0f.dat' % m_reward)
